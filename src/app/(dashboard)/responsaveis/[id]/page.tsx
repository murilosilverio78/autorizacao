...
export default function EditarResponsavelPage() {
  ...
  useEffect(() => {
    ...
    async function loadResponsavel() {
      const responsavel = await getResponsavel(params.id, userId);
      ...
      reset({
        ...
        rg: responsavel.rg,
        rgOrgaoExpedidor: responsavel.rgOrgaoExpedidor,
        rgDataExpedicao: responsavel.rgDataExpedicao,
        cpf: responsavel.cpf,
        endereco: responsavel.endereco,
        cidade: responsavel.cidade,
        uf: responsavel.uf,
        telefone: responsavel.telefone,
        qualidade: responsavel.qualidade,
      });
      setLoading(false);
    }
  ...
  async function onSubmit(data: ResponsavelInput) {
    ...
    await updateResponsavel(params.id, data, user.uid);
    router.push("/responsaveis");
  }

  if (loading) {
    return <p className="text-sm text-gray-600">Carregando responsável...</p>;
  }
